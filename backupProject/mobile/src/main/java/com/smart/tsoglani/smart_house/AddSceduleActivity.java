...
//                        e.printStackTrace();
    ...
    public void saveFunction(final View v) {
        ...
        try {
            ...
            sendDataToAll("saveShedule:DeviceID:" + devideIDSpinner.getSelectedItem().toString() + COMMAND_SPLIT_STRING + COMMAND_TEXT_STRING + tab_command_text_view.getSelectedItem().toString() + " " + command_mode.getSelectedItem().toString() +
