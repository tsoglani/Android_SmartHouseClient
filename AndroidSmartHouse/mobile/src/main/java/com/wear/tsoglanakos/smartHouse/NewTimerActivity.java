...
public class NewTimerActivity extends AppCompatActivity {
    ...
    private DiscreteSeekBar hour_bar, sec_bar, min_bar;
...
//        setSupportActionBar(toolbar);
        ...
        hour_bar = (DiscreteSeekBar) findViewById(R.id.time_hours_bar);
        sec_bar = (DiscreteSeekBar) findViewById(R.id.time_seconds_bar);
        min_bar = (DiscreteSeekBar) findViewById(R.id.time_min_bar);
        ...
        hour_bar.setOnProgressChangeListener(new DiscreteSeekBar.OnProgressChangeListener() {
                                                 @Override
        ...
        min_bar.setOnProgressChangeListener(new DiscreteSeekBar.OnProgressChangeListener() {
                                                @Override
                                                public void onProgressChanged(DiscreteSeekBar seekBar, final int value, boolean fromUser) {
                                                    runOnUiThread(new Thread() {
                                                                      @Override
        ...
        sec_bar.setOnProgressChangeListener(new DiscreteSeekBar.OnProgressChangeListener() {
                                                @Override
                                                public void onProgressChanged(DiscreteSeekBar seekBar, final int value, boolean fromUser) {
                                                    runOnUiThread(new Thread() {
                                                                      @Override
